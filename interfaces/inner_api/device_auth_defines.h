...
enum {
    ...
    HC_ERR_PLUGIN_HAS_INIT = 0x00000011,
    HC_ERR_PLUGIN_NOT_INIT = 0x00000012,
    HC_ERR_LOAD_PLUGIN_FAIL = 0x00000013,
    ...
    HC_ERR_INFORM_ERR = 0x00005011,
    HC_ERR_ONLY_ACCOUNT_RELATED = 0x00005012,
