...
typedef struct {
    ...
    void (*onAuthError)(int64_t requestId, const CompatibleAuthSubSession *session, int errorCode);
    ...
    int32_t (*getAuthParamsVecForServer)(const CJson *dataFromClient, ParamsVecForAuth *authParamsVec);
