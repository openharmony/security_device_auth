...
enum {
    ...
    CB_ID_ON_GROUP_ACTIVE_IN_USER,
    CB_ID_ON_GROUP_INACTIVE_IN_USER,
    CB_ID_ON_DEVICE_ACTIVE_IN_USER,
    CB_ID_ON_DEVICE_INACTIVE_IN_USER,
    CB_ID_ON_DEVICE_NOT_TRUSTED_IN_USER,
    CB_ID_ON_CRED_ACTIVE_IN_USER,
    CB_ID_ON_CRED_INACTIVE_IN_USER,
};
