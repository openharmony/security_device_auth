...
static const int32_t INT32_TYPES[] = {
    PARAM_TYPE_OS_ACCOUNT_ID, PARAM_TYPE_OPCODE
};

static const int32_t INT64_TYPES[] = {
    PARAM_TYPE_REQID
};
