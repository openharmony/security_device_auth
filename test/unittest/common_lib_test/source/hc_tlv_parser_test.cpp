...
// static const uint32_t TEST_UINT_MAX = 0xffffffffU;
}
...
void HcTlvParserTest::SetUpTestCase() {}
void HcTlvParserTest::TearDownTestCase() {}
void HcTlvParserTest::SetUp() {}
void HcTlvParserTest::TearDown() {}
