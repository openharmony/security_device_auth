...
static PubKeyExchangeParams g_paramsC = { 0, g_owner, g_groupId, g_authIdC };
static PubKeyExchangeParams g_paramsS = { 0, g_owner, g_groupId, g_authIdS };
...
{
    PubKeyExchangeParams errorParams = { 0, nullptr, g_groupId, g_authIdC };
...
{
    PubKeyExchangeParams errorParams = { 0, g_owner, nullptr, g_authIdC };
    BaseCmd *self = CreatePubKeyExchangeCmd((void *)(&errorParams), true, ABORT_IF_ERROR);
    ASSERT_EQ(self, nullptr);
}
...
{
    PubKeyExchangeParams errorParams = { 0, g_owner, g_groupId, { nullptr, 0 } };
    BaseCmd *self = CreatePubKeyExchangeCmd((void *)(&errorParams), true, ABORT_IF_ERROR);
    ASSERT_EQ(self, nullptr);
}
...
{
    PubKeyExchangeParams errorParams = { 0, g_owner, g_groupId, { (uint8_t *)g_authIdCVal, 0 } };
    BaseCmd *self = CreatePubKeyExchangeCmd((void *)(&errorParams), true, ABORT_IF_ERROR);
    ASSERT_EQ(self, nullptr);
}
