...
static PubKeyExchangeParams g_paramsC = { 0, OWNER, GROUP_ID, g_authIdC };
static PubKeyExchangeParams g_paramsS = { 0, OWNER, GROUP_ID, g_authIdS };
...
{
    PubKeyExchangeParams errorParams = { 0, OWNER, nullptr, g_authIdC };
    BaseCmd *self = CreatePubKeyExchangeCmd((void *)(&errorParams), true, ABORT_IF_ERROR);
    ASSERT_EQ(self, nullptr);
}
...
{
    PubKeyExchangeParams errorParams = { 0, OWNER, GROUP_ID, { nullptr, 0 } };
    BaseCmd *self = CreatePubKeyExchangeCmd((void *)(&errorParams), true, ABORT_IF_ERROR);
    ASSERT_EQ(self, nullptr);
}
...
{
    PubKeyExchangeParams errorParams = { 0, OWNER, GROUP_ID, { (uint8_t *)AUTH_ID_C_VAL, 0 } };
    BaseCmd *self = CreatePubKeyExchangeCmd((void *)(&errorParams), true, ABORT_IF_ERROR);
    ASSERT_EQ(self, nullptr);
}
