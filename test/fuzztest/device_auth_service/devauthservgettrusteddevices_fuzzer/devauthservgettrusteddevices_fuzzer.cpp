...
#include "devauthservgettrusteddevices_fuzzer.h"
...
namespace OHOS {
    ...
    bool FuzzDoGetTrustedDevices(const uint8_t* data, size_t size)
    {
        ...
        char *returnDevInfoVec = nullptr;
        uint32_t deviceNum = 0;
        gmInstance->getTrustedDevices(0, appId.c_str(), g_groupId, &returnDevInfoVec, &deviceNum);
